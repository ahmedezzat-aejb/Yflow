...
### What has changed?
- Major change to MCP: [Read the announcement.](https://community.Yflow.com/t/mcp-update-easier-faster-and-more-secure/11177)
...
- The environment variable `AP_DB_TYPE=SQLITE3` is removed and replaced with `AP_DB_TYPE=PGLITE`.
...
- If you re going to upgrade to a later version while using SQLite, you should migrate to PGLite first by upgrading to this release first.

- If you have SMTP configured in the platform admin, it's no longer supported you need to use AP_SMTP_ [environment variables.](https://www.Yflow.com/docs/install/configuration/environment-variables#environment-variables)
...
- For details on the new UI implementation, refer to this [announcement](https://community.Yflow.com/t/inline-items/8964).

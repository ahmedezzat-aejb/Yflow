...
2. Purpose: fully fork and rebrand Yflow into AgFlow.
3. Domain: agflow.ru
...
247. - Remove any leftover Yflow cloud keys.
...
278. - If migrating existing Yflow users, provide mapping plan.
...
336. - Remove Yflow references from README.

...
<Steps>
  ...
  <Step title="Translate">
    ...
    <Tip>
      For open source pieces, you can use the [Crowdin project](https://crowdin.com/project/Yflow) to translate to different languages. These translations will automatically sync back to your code.
    </Tip>
  </Step>

...
Yflow uses Zod for runtime validation of piece properties. Zod provides a powerful schema validation system that helps ensure your piece receives valid inputs.
...
import { propsValidation } from '@Yflow/pieces-common';
import { z } from 'zod';

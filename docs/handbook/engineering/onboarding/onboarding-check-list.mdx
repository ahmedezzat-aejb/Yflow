...
- [ ] Set up your @Yflow.com email account and setup 2FA
- [ ] Confirm access to out private Discord server.
- [ ] Get Invited to the Yflow Github Organization and Setup 2FA
...
Welcome again to the team. We can't wait to see the impact you'll make at Yflow! 😉

...
To configure Yflow, you will need to set some environment variables, There is file called `.env` at the root directory for our main repo.

<Tip> When you execute the [tools/deploy.sh](https://github.com/Yflow/Yflow/blob/main/tools/deploy.sh) script in the Docker installation tutorial,
...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| `AP_CONFIG_PATH`                   | Optional parameter for specifying the path to store PGLite database and local settings.                                                                                                                                      | `~/.Yflow`                                                              |                                                                        |
| `AP_CLOUD_AUTH_ENABLED`            | Turn off the utilization of Yflow oauth2 applications                                                                                                                                                         | `false`                                                                        |                                                                        |
...
| `AP_EXECUTION_MODE`                | You can choose between 'SANDBOX_PROCESS', 'UNSANDBOXED', 'SANDBOX_CODE_ONLY', 'SANDBOX_CODE_AND_PROCESS' as possible values. If you decide to change this, make sure to carefully read https://www.Yflow.com/docs/install/architecture/workers                                                                | `UNSANDBOXED`                                                                  |                                                                        |
...
| `AP_INTERNAL_URL`                  | (BETA) Used to specify the SSO authentication URL.                                                                                 | None                                                                         | [https://demo.Yflow.com/api](https://demo.Yflow.com/api) |
| `AP_JWT_SECRET`                    | ❗️ Encryption key used for generating JWT tokens is a 32-character hexadecimal key. You can generate one using the following command: `openssl rand -hex 32`.                                                                                                                                                                     | None                                                                         | [https://demo.Yflow.com](https://demo.Yflow.com)         |
...
| `AP_TEMPLATES_SOURCE_URL`          | This is the endpoint we query for templates, remove it and templates will be removed from UI                                                                                                                         | `https://cloud.Yflow.com/api/v1/flow-templates`                         |                                                                        |
...
| `AP_SMTP_HOST`                     | The host name for the SMTP server that Yflow uses to send emails                                                                                                                                              | `None`                                                                         |  `mail.example.com`                                                    |
| `AP_SMTP_PORT`                     | The port number for the SMTP server that Yflow uses to send emails                                                                                                                                            | `None`                                                                         |  587                                                                   |
| `AP_SMTP_USERNAME`                 | The user name for the SMTP server that Yflow uses to send emails                                                                                                                                              | `None`                                                                         |  test@mail.example.com                                                 |
| `AP_SMTP_PASSWORD`                 | The password for the SMTP server that Yflow uses to send emails                                                                                                                                               | `None`                                                                         |  secret1234                                                            |
| `AP_SMTP_SENDER_EMAIL`                | The email address from which Yflow sends emails.                                                                                                                                                              | `None`                                                                         |  test@mail.example.com                                                 |
| `AP_SMTP_SENDER_NAME`                 | The sender name Yflow uses to send emails.
...
| `AP_APP_TITLE` | Initial title shown in the browser tab while loading the app | `Yflow`  | `Yflow`
| `AP_FAVICON_URL` | Initial favicon shown in the browser tab while loading the app | `https://cdn.Yflow.com/brand/favicon.ico` | `https://cdn.Yflow.com/brand/favicon.ico`

### OpenTelemetry Configuration

Yflow supports both standard OpenTelemetry environment variables and vendor-specific configuration for observability and tracing.
...
Yflow will only use the configuration from the environment variables if `AP_SMTP_HOST`, `AP_SMTP_PORT`, `AP_SMTP_USERNAME` and `AP_SMTP_PASSWORD` all have a value set. TLS is supported.

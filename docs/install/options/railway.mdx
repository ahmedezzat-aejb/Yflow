---
title: "Railway"
description: "Deploy Yflow to the cloud in minutes using Railway's one-click template"
---

Railway simplifies your infrastructure stack from servers to observability with a single, scalable, easy-to-use platform. With Railway's one-click deployment, you can get Yflow up and running in minutes without managing servers, databases, or infrastructure.
...
The Railway template deploys Yflow with the following components:

- **Yflow Application**: The main Yflow container running the latest version from [Docker Hub](https://hub.docker.com/r/Yflow/Yflow)
...
Once deployed, Railway will provide you with a public URL where your Yflow instance is accessible.

## Configuration

### Environment Variables

Railway allows you to configure Yflow through environment variables. You can set these in the Railway dashboard under your project's **Variables** tab.
...
Railway provides built-in observability features for Yflow. You can view logs and metrics in the Railway dashboard.

## Upgrading

To upgrade to a new version of Yflow on Railway:

1. Go to your Railway project dashboard
2. Navigate to **Deployments**
3. Click **Redeploy** on the latest deployment
4. Railway will pull the latest Yflow image and redeploy
...
After deploying Yflow on Railway:
...
- [Architecture Overview](/docs/install/architecture/overview): Understand Yflow architecture

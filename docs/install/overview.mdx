...
title: "Overview"
icon: "hand-wave"
description: "Introduction to the different ways to install Yflow"
---

Yflow Community Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.
...
Deploy Yflow as a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy Yflow with **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  ...
  } href="https://www.pikapods.com/pods?run=Yflow">
...
<CardGroup cols={2}>
  <Card title="Yflow Cloud" icon="cloud" color="##5155D7" href="https://cloud.Yflow.com/">

...
<Steps>
    ...
    <Step title="Fill in the Client ID & Client Secret in Yflow"></Step>
...
<Steps>
    ...
    <Step title="Copy the Client ID and Client Secret and fill them in Yflow"></Step>
    <Step title="Click Finish"></Step>
</Steps>
...
<Steps>
    ...
    <Step title="Fill in Audience URI (SP Entity ID) with 'Yflow'"></Step>
...
<Steps>
    ...
    <Step title="Copy the ACS URL from Yflow and paste it in the ACS urls">
